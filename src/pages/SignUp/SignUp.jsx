      ...
      <div className='mx-auto max-w-lg'>
        ...
        <form action='' className='mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8'>
          ...
          <div>
            ...
            <div className='relative'>
              <input type='password' className='w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm' placeholder='Confirm Password' />
          ...
          <p className='text-center text-sm text-gray-500'>
            Shop without sign-up? <span className='underline cursor-pointer'>Take me home</span>
          </p>
        </form>
      </div>
    </div>
