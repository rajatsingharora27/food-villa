  ...
  return (
    <div className='flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full'>
      <div className='text-center'>
        ...
        <h1 className='mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]'>{prop.message}</h1>
        <div className='flex flex-col gap-y-6 justify-center items-center'>
          {" "}
          <p className='text-slate-600 mt-5 lg:text-lg'>{prop.info}</p>
          <button className='bg-green-400 w-1/2 hover:bg-green-200 text-white font-bold py-2 px-4 rounded' onClick={() => navigate("/")}>
            Go Home
          </button>
        </div>
      </div>
